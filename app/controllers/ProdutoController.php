...
function salvarNovoProduto($pdo)
{
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Chama a função do model para cadastrar o produto
        cadastrarProduto($pdo, $dadosProduto);

        // Redireciona o usuário para a lista de produtos após salvar
        header('Location: ?page=produtos');
        exit;
    } else {
        // Se alguém tentar acessar a URL diretamente, redireciona também
        header('Location: ?page=produtos');
        exit;
    }
}
